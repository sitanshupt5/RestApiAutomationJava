...
public class ApiUtilManager {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(ApiUtilManager.class);
    ...
    public String getRequestBody(TestManagerContext testManagerContext,
                                 String customer)
            throws IOException, URISyntaxException, ParseException {

        ObjectMapper mapper = new ObjectMapper();
        String api = (String) testManagerContext.getScenarioContext()
        ...
        if (defaults.get("request") != null) {
            ...
            String requestTemplate =
                    defaults.get("request").toPrettyString();
            ...
            if (!Strings.isNullOrEmpty(customer)) {
                ...
                ObjectReader updater =
                        mapper.readerForUpdating(defaults.get(Entity.REQUEST));

                JSONObject data = new JSONObject(
                        updater.readTree(
                                        mapper.writeValueAsString(
                                                getData(testManagerContext,
                                                        customer, api)))
                                .toPrettyString());
            ...
            return request
                    ...
                    .replace("{ID}",
                            (String) testManagerContext
                                    .getScenarioContext()
                                    .getContext(ApiContext.ID))
                    .replace("{RandomUUID}",
                            getUniqueCorrelationid())
                    .replace("{currentdate}",
                            DateUtils.getTodayDateInString());
        }
    ...
    public String mapData(Object payload, JSONObject data) {
        ...
        payloadTxt = payloadTxt.replaceAll(
                "\"\\[(.*?)]\"",
                "EmptyObject");

        return removeEmptyJsonElements(
                new JSONTokener(payloadTxt).nextValue());
    }
        ...
        if (object instanceof JSONArray) {
            ...
            for (; num >= 0; num--) {
                ...
                if (array.get(num).toString().equals("{}")) {
                    ...
                    try {
                        removeEmptyJsonElements(
                                array.getJSONObject(num));
            ...
            while (els.hasNext()) {
                ...
                if (jsonObject.get(key).toString()
                        .equals("EmptyObject")
                        || jsonObject.isEmpty()
                        || jsonObject.get(key)
                        .toString().equals("[]")) {
    ...
    public Map<String, String> getHeader(String api,
                                         String customerID)
        ...
        return mapper.convertValue(
                defaults.get(Entity.HEADER),
                new TypeReference<Map<String, String>>() {
                });
    }

    public String getBasePath(String api)
            throws IOException, URISyntaxException {
    ...
    public String mapQueryData(String query,
    ...
    public void setEntityHostURI(String api,
        ...
        if (!Strings.isNullOrEmpty(entity_host_uri)) {
            ...
            testManagerContext.configManager.put(
                    ConfigConstants.ENTITY_HOST_URI, "");
        }

        entity_host_uri =
                getJsonNodeValue(defaults, Entity.HOST_URI);
    ...
    public Map<String, String> getParams(String api)
            throws IOException, URISyntaxException {
        ...
        return mapper.convertValue(
                defaults.get(Entity.PARAMS),
                new TypeReference<Map<String, String>>() {
                });
    }

    public Map<String, String> getAuthParams(String api)
        ...
        return mapper.convertValue(
                defaults.get(Entity.AUTH_PARAMS),
                new TypeReference<Map<String, String>>() {
                });
    }
    ...
    public Map<String, String> getQueryParams(
        ...
        if (customer == null) {
            ...
            return mapper.convertValue(
                    defaults.get(Entity.QUERY_PARAMS),
                    new TypeReference<Map<String, String>>() {
                    });
        }
    ...
    public Map<String, Object> getSchema(
            String schemaKey, String api) {

        String filePath = FilePaths.SCHEMA_MAPPING
                .replace(Entity.API_PATH, api)
                .replace(Entity.ENV_TYPE, env);

        YamlReaderUtils yamlReaderUtils =
                new YamlReaderUtils(
    ...
    public String getValue(String schemaKey, String api) {
        ...
        return (String)
                yamlReaderUtils.getValue(schemaKey);
    }
    ...
    public static String getJsonNodeValue(
            String jsonString, String nodeKey)
            throws IOException {
        ...
        if (nodeKey.contains("/")) {
            return node.at(nodeKey) == null
                    ? null
                    : node.at(nodeKey).asText();
        } else {
            return node.get(nodeKey) == null
                    ? null
                    : node.get(nodeKey).asText();
        }
    }

    public String getJsonNodeValue(
            JsonNode data, String nodeKey) {

        JsonNode node =
                data.isArray() ? data.get(0) : data;
    ...
    public ObjectNode getDefaults(String api)
            throws URISyntaxException, IOException {
    ...
    public String getTestDataFilePath(String api) {
        ...
        return FilePaths.TEST_DATA_FILE_PATH
                .replace(Entity.API_PATH, api)
                .replace(Entity.ENV_TYPE, env);
    }
    ...
    public void setDataSet(
        ...
        testManagerContext.getScenarioContext()
                .setContext(
                        ApiContext.DATASET,
                        yamlReaderUtils.getValue(customer));
    }
    ...
    public Object getData(
        ...
        return testManagerContext.getScenarioContext()
                .getContext(ApiContext.DATASET);
    }
    ...
    public JSONObject readDataFile(
        ...
        ObjectReader updater =
                mapper.readerForUpdating(
                        getDefaults(api).get(Entity.REQUEST));
