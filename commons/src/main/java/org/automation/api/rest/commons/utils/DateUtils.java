...
public class DateUtils {
    ...
    private static Date convertStringToDate(String date, String dateFormat) {
    ...
    public static Date convertStringToDateFormat(String date) {return convertStringToDate(date, dateFormat_YYYYMMDD);}
