...
public enum TimeUnit {
    ...
    HOURS(java.util.concurrent.TimeUnit.HOURS, "h", "hr", "hour", "hours");
    ...
    public static TimeUnit of(String key) {
        ...
        throw new IllegalArgumentException("No time unit found for "+ key);
    }

    public java.util.concurrent.TimeUnit getTimeUnit(){return timeUnit;}
}
