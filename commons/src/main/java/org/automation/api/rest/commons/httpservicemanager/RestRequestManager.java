...
public class RestRequestManager {
    ...
    public void multiPart(String contentBody,
                          String controlName,
                          String mimeType) {
    ...
    public void multiPart(byte[] contentBody,
                          String controlName,
                          String mimeType) {

        specification().multiPart(controlName,
                "file.txt",
                contentBody,
                mimeType);
    }
    ...
    public void setAuthCredentials(Map<String, String> credentials) {
        if (credentials.containsKey(ConfigConstants.USERNAME)
                && credentials.containsKey(ConfigConstants.PASSWORD)) {

            httpRequestManager.basicAuthentication(
                    credentials.get(ConfigConstants.USERNAME),
                    credentials.get(ConfigConstants.PASSWORD));
        }
    }
}