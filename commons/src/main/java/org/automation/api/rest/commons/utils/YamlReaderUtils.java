...
import io.cucumber.messages.internal.com.google.protobuf.DiscardUnknownFieldsParser;
...
public class YamlReaderUtils {
    ...
    *
    * @param fileName of the given file input stream
    */
    ...
    */
    ...
    /*
    * Gets a Map from a list with a key and and index
    *
    ...
    * */
    ...
    /*
    * Get a list with the specified key
    ...
    */
    public static void writeToNewYamlFile(final String newYamlFileName, final Map<String, Object> newData)
    {
        ...
        try(final FileWriter writer = new FileWriter(file, true)) {
            ...
            throw new RuntimeException("Error occurred while creating new file "+newYamlFileName, e);
        }
    }
    ...
    * @param newData    the data to be appended to the file
    * */
